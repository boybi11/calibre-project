...
<ol class="breadcrumb">
  ...
  <li><a href="{{route('adminProductsEdit', [$data->id])}}">Edit</a></li>
...
<div class="col-sm-12">
  ...
  {!! Form::open(['route'=>['adminProductsCrop', $data->id], 'files' => true, 'method' => 'patch', 'class'=>'form form-parsley form-crop']) !!}
