  ...
  <div class="widget">
    <div class="header">
      ...
      <div class="pull-right">
        <a class="btn-transparent btn-sm" href="{{route('adminLongNames')}}"><i class="fa fa-eye"></i> Show All</a>
        <a class="btn-transparent btn-sm" href="{{route('adminLongNamesCreate')}}"><i class="fa fa-plus-circle"></i> Create</a>
        <a class="btn-transparent btn-sm" href="#" data-toggle="modal" data-target="#delete-modal"><i class="fa fa-minus-circle"></i> Delete</a>
      </div>
    </div>
    <div class="filters">
      {!! Form::open(['route'=>'adminLongNames', 'method' => 'get']) !!}
      <label>
    ...
    <div class="table-responsive">
      {!! Form::open(['route'=>'adminLongNamesDestroy', 'method' => 'delete', 'class'=>'form form-parsley form-delete']) !!}
          ...
          <tr>
            ...
            <td width="110px" class="text-center">
              <button type="button" class="btn btn-primary btn-xs" role="button" data-toggle="popover" 
                ...
                data-content="@include('admin.long_names.show', ['data' => $d])">
                VIEW
              </button>
              <a href="{{route('adminLongNamesEdit', [$d->id])}}" class="btn btn-primary btn-xs">EDIT</a>
            </td>
          </tr>
          @endforeach
        </tbody>
